...
import 'package:bima_application/features/firebaseauth/presentation/pages/firebase_auth_page.dart';
import 'package:bima_application/features/firebaseauth/presentation/widgets/loading.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'doctor_detail_page.dart';

class DocotorListPage extends StatelessWidget {
  const DocotorListPage({Key? key}) : super(key: key);
...
class DisplayDoctorList extends StatelessWidget {
  ...
  const DisplayDoctorList({Key? key, required this.doctorsList})
      : super(key: key);
